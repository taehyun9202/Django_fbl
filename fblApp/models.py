...
class User(models.Model):
    ...
    cover = models.ImageField(upload_to="forums", default='/coverdefault.jpg', blank=True, null=True)
    pic = models.ImageField(upload_to="forums", default='/Default.png', blank=True, null=True)
...
class Post(models.Model):
    ...
    image = models.FileField(upload_to="forums", default=None, blank=True, null=True)
